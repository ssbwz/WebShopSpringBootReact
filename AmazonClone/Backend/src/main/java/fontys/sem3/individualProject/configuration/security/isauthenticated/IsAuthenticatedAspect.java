package fontys.sem3.individualProject.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(fontys.sem3.individualProject.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(fontys.sem3.individualProject.configuration.security.isauthenticated.IsAuthenticated)")
